...
def get_pt_agent(user_context: str, knowledge_base: Knowledge, user_data: dict, enable_tools: bool = True) -> Agent:
    ...
    pt_agent = Agent(
        ...
        instructions=[
            ...
            "- Se l'utente ti chiede QUALSIASI argomento, materia o conversazione non strettamente legata al fitness, all'allenamento fisico, all'esercizio o al tuo ruolo (es. storia, politica, programmazione, attualità, geografia, matematica, intrattenimento, o discorsi generici): DEVI RIFIUTARE educatamente e riportare la conversazione sul tuo ambito, dicendo che puoi aiutare solo su temi di allenamento e fitness.",
